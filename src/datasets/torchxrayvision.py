# This file comes originally from the the torchxrayvision library
...
#
# or in the "torchxrayvision_license" file accompanying this file. This file is distributed
...
# todo: install imageio and scikit-image on metacentrum
...
class NIH_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # add color channel
        sample["img"] = img[:, :, None]
        #sample["img"] = img.reshape(img.shape[0], img.shape[1], 1)
...
class NIH_Google_Dataset(Dataset):
    ...
    def __init__(self,
                 imgpath,
                 csvpath=USE_INCLUDED_FILE,
                 orig_csvpath=USE_INCLUDED_FILE,
                 views=["PA"],
                 transform=None,
                 data_aug=None,
                 nrows=None,
        ...
        # Original csv
        self.orig_csv = pd.read_csv(orig_csvpath)
        self.csv["patientid"] = self.orig_csv["Patient ID"].astype(str)
